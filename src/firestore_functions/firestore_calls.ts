...
export const addMovieToPlaylist = async (playlist: string, movieId: number, posterPath: string) =>{ 
    ...
    const playlistRef = doc(db, 'users', '3rsr7exqdjb0JomRGEeXr1XZBrH2', 'Shelf', playlist)
...
// export const addMovieToPlaylist = async (userId: string, playlist: string, movie: MovieProps) =>{
//     const playlistRef = doc(db, 'users', userId, 'Shelf', playlist)
//     await updateDoc(playlistRef, {
